                    ...
                    <div className="flex flex-col sm:flex-row mt-6">
                        <div className="w-full sm:w-1/2 rounded-lg scrollbar-hide p-4 overflow-y-auto h-[300px]">
                            <label className="flex items-center">
                                ...
                                />
                                <span className="text-blue-600 text-lg font-bold ml-5">Asset Management</span>
                            </label>
                            ...
                            {isAsmChecked && (
                                <div className="ml-5 mt-3">
                                    ...
                                    {isCategoryChecked && (
                                        <div className="ml-6 mt-2">
                                            <label className="flex items-center mt-2">
                                                <input
                                                    type="checkbox"
                                                    onChange={() => setIsAllCategoryChecked(!isAllCategoryChecked)}
                                            ...
                                            <label className="flex items-center mt-2">
                                                <input
                                                    type="checkbox"
                                                    onChange={() => setIsRawMaterialChecked(!isRawMaterialChecked)}
                                    ...
                                    <label className="flex items-center mt-2">
                                        <input
                                            type="checkbox"
                                            onChange={() => setIsValuationChecked(!isValuationChecked)}
