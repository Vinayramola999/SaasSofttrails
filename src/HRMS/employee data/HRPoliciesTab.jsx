        ...
        const fetchPolicies = async () => {
            ...
            try {
                const [policyRes, categoryRes] = await Promise.all([
                    fetch("https://devapi.softtrails.net/hrms/test/hr-policy/policies", {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "application/json",
                        },
                    }),
                    fetch("https://devapi.softtrails.net/hrms/test/hr-policy/categories", {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "application/json",
                        },
                            ...
                            {currentPolicies.length > 0 ? (
                                currentPolicies.map((policy, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-3 text-left text-gray-700">{policy.description || "NA"}</td>
                                        ...
                                        <td className="px-5 py-3 text-blue-600 underline text-left">
                                            <a
                                                href={`https://devapi.softtrails.net/hrms/test/hr-policy/policies-doc/${policy.policy_id}`}
                                                target="_blank"
