...
const SalarySlip = () => {
    ...
    const fetchHRDocuments = async () => {
        try {
            ...
            console.error("Error fetching Finance Department docs:", error);
        }
    };
    ...
    const CategoryOptionComponent = (props) => {
        ...
        return (
            <div {...props.innerProps} className="flex justify-between items-center px-2 py-1 cursor-pointer hover:bg-gray-100" >
                ...
                {!data.isAddNew && (
                    <span className="text-red-500 hover:text-red-700" onClick={(e) => { e.stopPropagation(); handleDeleteCategory(data.value); }}><DeleteIcon /></span>
                )}
            </div>
        );
    };
    ...
    return (
        <div>
            <div className="flex items-center mb-4 gap-4">
                <AddButton onClick={() => setShowForm(true)} icon={FaPlus}>Add Salary Slip</AddButton>
                    ...
                    <div className="bg-white p-6 rounded w-[600px] max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-2 gap-4 mb-4">
                                {/* Category Dropdown */}
                                <div>
                                    <label className="text-sm font-medium">Salary Slip <span className="text-red-500">*</span></label>
                                    <Select
                                ...
                                <div className="flex flex-col">
                                    ...
                                    />
                                    <p className="text-xs text-gray-500 mt-1">Only PDF allowed and max size is 1MB</p>
                                </div>
                            </div>
