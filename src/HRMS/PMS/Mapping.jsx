...
const MappingComponent = () => {
    ...
    // useEffect(() => {
    //     axios.get("https://devapi.softtrails.net/saas/test/pms/goals").then(res => setGoals(res.data));
    //     axios.get("https://devapi.softtrails.net/saas/test/departments").then(res => setDepartments(res.data));
    //     axios.get("https://devapi.softtrails.net/saas/test/pms/kra").then(res => setKras(res.data));
    //     fetchMappings();
    // }, []);

    // const fetchMappings = () => {
    //     axios.get("https://devapi.softtrails.net/saas/test/pms/goal-kra-dept-mapping")
    ...
    //     };
    //     axios.post(
    //         "https://devapi.softtrails.net/saas/test/pms/goal-kra-dept-mapping",
    //         {
    ...
    useEffect(() => {
        ...
        axios
            .get("https://devapi.softtrails.net/saas/test/pms/goals", { headers })
            .then(res => setGoals(res.data))
            .catch(err => console.error("Failed to fetch goals", err));

        axios
            .get("https://devapi.softtrails.net/saas/test/departments", { headers })
            .then(res => setDepartments(res.data))
            .catch(err => console.error("Failed to fetch departments", err));

        axios
            .get("https://devapi.softtrails.net/saas/test/pms/kra", { headers })
    ...
    const fetchMappings = () => {
        const token = sessionStorage.getItem("token");
        axios
            .get("https://devapi.softtrails.net/saas/test/pms/goal-kra-dept-mapping", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
                            ...
                            <button
                                onClick={async () => {
                                    try {
                                        const token = sessionStorage.getItem("token");
                                        await axios.put(
                                            `https://devapi.softtrails.net/saas/test/pms/goal-kra-dept-mapping/${editingMapping.id}`,
                                            {
