...
const KRAComponent = () => {
    ...
    // useEffect(() => {
    //     axios
    //         .get("https://devapi.softtrails.net/saas/test/pms/goals")
    ...
    // // Fetch all KRAs
    // const fetchKRAs = () => {
    //     axios.get("https://devapi.softtrails.net/saas/test/pms/kra")
    ...
    //     if (kra && goalId) {
    //         try {
    //             const response = await axios.post("https://devapi.softtrails.net/saas/test/pms/kra", {
    //                 kra_name: kra,
    ...
    const fetchKRAs = () => {
        const token = sessionStorage.getItem("token");
        axios
            .get("https://devapi.softtrails.net/saas/test/pms/kra", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
        ...
        if (kra && goalId) {
            try {
                ...
                const response = await axios.post(
                    "https://devapi.softtrails.net/saas/test/pms/kra",
                    {
                        kra_name: kra,
                        goal_id: parseInt(goalId),
                    },
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            const token = sessionStorage.getItem("token");
            await axios.delete(
                `https://devapi.softtrails.net/saas/test/pms/kra/${kraToDelete.id}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                onClick={async () => {
                                    try {
                                        const token = sessionStorage.getItem("token");
                                        await axios.put(`https://devapi.softtrails.net/saas/test/pms/kra/${selectedKRA.id}`,
                                            {
                                                kra_name: updatedKRA,
