        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" name="allocation" value={formData.allocation} onChange={handleChange} className={`w-full border rounded-md p-2 focus:ring-2 focus:ring-blue-400 outline-none ${errors.allocation ? "border-red-500" : "border-gray-300" }`} placeholder="Enter Allocation" min="0" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" name="constraint_value" value={formData.constraint_value} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-400 outline-none" placeholder="Enter Constraint Value" min="0" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" name="no_of_tranches" value={formData.no_of_tranches} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-400 outline-none" placeholder="Enter No. of Tranches" min="0" />
            </div>
          </div>
            ...
            <div>
              ...
              {formData.consecutive_leave_restriction === true && (
                <div className="mt-3">
                  ...
                  <input type="number" name="consecutive_leave_gap_days" value={formData.consecutive_leave_gap_days} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-400 outline-none" placeholder="Enter No. of Days" min="0" step="1" />
                </div>
              )}
            </div>
          </div>
            ...
            {formData.carry_forward_enabled && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                ...
                <div>
                  ...
                  <input type="number" name="carry_forward_monthly_value" value={formData.carry_forward_monthly_value ?? ""} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2" placeholder="Enter Monthly Value" min="0" />
                ...
                <div>
                  ...
                  <input type="number" name="carry_forward_yearly_value" value={formData.carry_forward_yearly_value ?? ""} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2" placeholder="Enter Yearly Value" min="0" disabled={!formData.carry_forward_monthly_type || formData.carry_forward_monthly_value === null || formData.carry_forward_monthly_value === ""} />
                </div>
              </div>
            )}
          </div>
            ...
            <div>
              ...
              {formData.threshold_enabled && (
                <div className="mt-2">
                  ...
                  <input type="number" name="threshold_value" value={formData.threshold_value} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2" placeholder="Enter Threshold Value" min="0" />
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {formData.document_required && (
                <div className="mt-2">
                  ...
                  <input type="number" name="document_threshold" value={formData.document_threshold} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2" placeholder="Enter Document Value" min="0" />
                </div>
              )}
            </div>
          </div>
