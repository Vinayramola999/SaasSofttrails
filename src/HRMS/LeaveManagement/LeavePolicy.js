...
//                 'https://devapi.softtrails.net/hrms/test/leave/sandwich', { enabled },
//                 {
//                     headers: {
...
//         const token = sessionStorage.getItem('token');
//         try {
//             const response = await axios.get('https://devapi.softtrails.net/hrms/test/leave/sandwich', {
//                 headers: {
//                     'Authorization': `Bearer ${token}`,
//                     'Content-Type': 'application/json',
//                 },
...
//         try {
//             const response = await axios.post('https://devapi.softtrails.net/hrms/test/leave/set-condition', { condition: leaveValue },
//                 {
//                     headers: {
...
//         const token = sessionStorage.getItem('token');
//         try {
//             const response = await axios.get('https://devapi.softtrails.net/hrms/test/leave/get-condition', {
//                 headers: {
//                     'Authorization': `Bearer ${token}`,
//                     'Content-Type': 'application/json',
//                 },
...
//         const token = sessionStorage.getItem('token');
//         try {
//             const response = await axios.get('https://devapi.softtrails.net/hrms/test/leave/manual-trigger-monthly', {
//                 headers: {
//                     'Authorization': `Bearer ${token}`,
//                     'Content-Type': 'application/json',
//                 },
...
//         const token = sessionStorage.getItem('token');
//         try {
//             const response = await axios.get('https://devapi.softtrails.net/hrms/test/leave/manual-trigger-yearly', {
//                 headers: {
//                     'Authorization': `Bearer ${token}`,
//                     'Content-Type': 'application/json',
//                 },
...
//                 "https://devapi.softtrails.net/hrms/test/leave/leave-policies",
