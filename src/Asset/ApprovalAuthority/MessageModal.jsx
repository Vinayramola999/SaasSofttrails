  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <h2
          className={`text-center text-3xl font-bold mt-6 ${isSuccess ? "text-blue-600" : "text-red-600"}`}
        >
          {isSuccess ? "Success!" : "Error!"}
        </h2>

        {/* Message */}
        <p className="mt-4 text-center text-gray-700 text-lg font-bold ">{message}</p>
