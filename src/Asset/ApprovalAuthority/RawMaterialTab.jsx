...
import RawMaterial from "./RawMaterialMain";
      ...
      <div className="w-full">
        <Box>
          <div className="flex justify-left font-bold  mt-3 border-gray-300">
            ...
            >
              Material Lifecycle Request
            </button>
            <button
              className={`px-6 py-2 text-14px font- relative focus:outline-none transition duration-300 rounded-t-md ${tabValue === 2
                  ? "bg-white text-blue-600 border-l border-t border-r border-gray-300"
                  : "bg-gray-200 text-gray-600"
                }`}
