            ...
            <div className="relative flex flex-wrap justify-start gap-2 md:gap-3 pb-2 pl-2 md:pl-6">
              ...
              {tabs.map((tab, index) => (
                <button
                  ...
                  className={`relative z-10 flex-1 text-center py-2 px-4 font-bold rounded-full transition-all duration-300 ${activeTab === tab.id
                      ? "text-white"
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                          <button
                            ...
                            className={`px-6 py-2 rounded-md font-bold shadow-sm transition duration-200 ${dateOption === "today"
                          ...
                          {selectedMethod !== "SLM" && (
                            <button
                              ...
                              className={`px-6 py-2 rounded-md font-bold shadow-sm transition duration-200 ${dateOption === "custom"
                                  ? "bg-blue-600 text-white"
                                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                                }`}
                            >
                                ...
                                {selectedMethod === "WDV" && (
                                  <>
                                    ...
                                    <td className="px-5 py-3 text-left text-gray-700">
                                      {item["Years Used"] === 0
                                        ? "New asset"
                                        : `Used for ${item["Years Used"]} year${item["Years Used"] > 1 ? "s" : ""
                                        }`}
                                    </td>
                                  </>
                                )}
